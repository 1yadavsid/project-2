...
def load_dataset(file_path):
    try:
        # Attempt to read the CSV file with 'ISO-8859-1' encoding (Latin-1)
        return pd.read_csv(file_path, encoding='ISO-8859-1')
    except UnicodeDecodeError:
        # If that fails, try another encoding (e.g., cp1252)
        print("Error loading with 'ISO-8859-1' encoding, trying 'cp1252'...")
